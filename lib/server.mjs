...
import { StateStore, validModel } from './states.mjs';
    ...
    try {
      ...
      if (url.pathname.startsWith('/api/')) {
        ...
        if (url.pathname === '/api/rules/model' && req.method === 'POST') {
          ...
          else if(action==='save')rules[model]={...(existing||{ttlSeconds:300,scope:'session',unknownPolicy:'pass',autoLearn:false}),...body.rule};
          else {
