...
export class AutomaticGate {
  ...
  async run(job,routing,requestPath) {
    ...
    while(!signal.aborted) {
      ...
      p.lastResult={status:out.status,length:out.length,responseModel:out.responseModel,outcome,modelReportedDifferent:!!out.responseModel&&out.responseModel!==ctx.model,acceptance:'length'};
